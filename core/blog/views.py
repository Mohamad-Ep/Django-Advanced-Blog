...
class PostList(PermissionRequiredMixin,ListView):
    # model = Post
    permission_required = ('blog.view_post','blog.add_post')    # or permission_required = 'blog.change_post'
...
class PostCreateView(LoginRequiredMixin,CreateView):
    ...
    def form_valid(self, form):
        form.instance.author = self.request.user        # برای زمانی که میخواهیم نویسنده رو بصورت اتوماتیک اون یوزری که لاگین هست قرار دهیم
        return super().form_valid(form)
